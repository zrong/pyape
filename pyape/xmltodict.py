...
""" 
2020-04-02 zrong
基于版本： https://github.com/martinblech/xmltodict/commit/d6a83774150afb7b99c43a982fb4009e91e50f6f
加入 unparse 的 !<CDATA[]] 支持，479, 482 行

另一种方法（不修改 xmltodict 源码）：

将 <![CDATA[]] 作为字符串加入 text
调用 xmltodict.unparse，会将 <!CDATA[]] 中的标识符转义
调用 xml.sax.saxutils.unescape 反转义
"""
